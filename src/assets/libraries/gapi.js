...
(function() {
    ...
    var n = window,
        ...
        fa = function(a) { for (var b = 0; b < this.length; b++)
                if (this[b] === a) return b;
            return -1 },
        ga = function(a) { a = a.sort(); for (var b = [], c = void 0, d = 0; d < a.length; d++) { var e = a[d];
                e != c && b.push(e);
                c = e } return b },
        ha = /&/g,
        ia = /</g,
        ...
        z = function(a) { if (ea.test(Object.keys)) return Object.keys(a); var b = [],
                c; for (c in a) x(a, c) && b.push(c); return b },
        A = function(a, b) { a = a || {}; for (var c in a) x(a, c) && (b[c] = a[c]) },
        na = function(a) { return function() { n.setTimeout(a, 0) } },
        B = function(a, b) { if (!a) throw Error(b || ""); },
        C = u(n, "gapi", {});
    var D = function(a, b, c) { var d = new RegExp("([#].*&|[#])" + b + "=([^&#]*)", "g");
        ...
        E = function(a) {
            a = String(a);
            a = a.replace(pa, function(a) { try { return encodeURIComponent(a) } catch (f) { return encodeURIComponent(a.replace(/^[^%]+$/g, "\ufffd")) } }).replace(ra, function(a) { return a.replace(/%/g, "%25") }).replace(sa, function(a) { return a.toUpperCase() });
            a = a.match(oa) || [];
            var b = v(),
                c = function(a) {
        ...
        ua = function(a) { return a.v + (0 < a.query.length ? "?" + a.query.join("&") : "") + (0 < a.c.length ? "#" + a.c.join("&") : "") },
        ...
        za = /^https?:\/\/[^\/%\\?#\s]+\/[^\s]*$/i;
    var H = function(a, b, c, d) { if (n[c + "EventListener"]) n[c + "EventListener"](a, b, !1);
            else if (n[d + "tachEvent"]) n[d + "tachEvent"]("on" + a, b) },
        Aa = function() { var a = p.readyState; return "complete" === a || "interactive" === a && -1 == navigator.userAgent.indexOf("MSIE") },
        Da = function(a) { var b = Ba; if (!Aa()) try { b() } catch (c) {}
            Ca(a) },
        Ca = function(a) {
            if (Aa()) a();
            else {
                ...
                n.addEventListener ? (n.addEventListener("load", c, !1), n.addEventListener("DOMContentLoaded", c, !1)) : n.attachEvent &&
                    (n.attachEvent("onreadystatechange", function() { Aa() && c.apply(this, arguments) }), n.attachEvent("onload", c))
            }
        },
        Ea = function(a) { for (; a.firstChild;) a.removeChild(a.firstChild) },
        Fa = { button: !0, div: !0, span: !0 };
    var I;
    I = u(n, "___jsl", v());
    u(I, "I", 0);
    u(I, "hel", 10);
    var J = function(a) { return I.dpo ? I.h : D(a, "jsh", I.h) },
        Ga = function(a) { var b = u(I, "sws", []);
            b.push.apply(b, a) },
        Ha = function(a) { return u(I, "watt", v())[a] },
        Ia = function(a) { var b = u(I, "PQ", []);
            I.PQ = []; var c = b.length; if (0 === c) a();
            else
                for (var d = 0, e = function() {++d === c && a() }, f = 0; f < c; f++) b[f](e) },
        Ja = function(a) { return u(u(I, "H", v()), a, v()) };
    var K = u(I, "perf", v()),
        Ka = u(K, "g", v()),
        La = u(K, "i", v());
    u(K, "r", []);
    v();
    v();
    var Ma = function(a, b, c) { var d = K.r; "function" === typeof d ? d(a, b, c) : d.push([a, b, c]) },
        L = function(a, b, c) { Ka[a] = !b && Ka[a] || c || (new Date).getTime();
            Ma(a) },
        Oa = function(a, b, c) { b && 0 < b.length && (b = Na(b), c && 0 < c.length && (b += "___" + Na(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = u(La, "_p", v()), u(b, c, v())[a] = (new Date).getTime(), Ma(a, "_p", c)) },
        Na = function(a) { return a.join("__").replace(/\./g, "_").replace(/\-/g, "_").replace(/\,/g, "_") };
    var Pa = v(),
        M = [],
        N = function(a) { throw Error("Bad hint" + (a ? ": " + a : "")); };
    M.push(["jsl", function(a) { for (var b in a)
            if (x(a, b)) { var c = a[b]; "object" == typeof c ? I[b] = u(I, b, []).concat(c) : u(I, b, c) }
    ...
    var Qa = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Ta = /^gapi\.loaded_[0-9]+$/,
        Ua = /^[a-zA-Z0-9,._-]+$/,
        Ya = function(a, b, c, d) { var e = a.split(";"),
                f = e.shift(),
                g = Pa[f],
                k = null;
            ...
            b = k;
            c = b.match(Va);
            (d = b.match(Wa)) && 1 === d.length && Xa.test(b) && c && 1 === c.length || N("failed sanity: " + a); return k },
        ab = function(a, b, c, d) {
            a = Za(a);
        ...
        Za = function(a) {
            ...
            e = bb(a, "rs");
            a = bb(a, "t");
            return { Z: b, version: c, J: d, S: e, U: a }
        },
        $a = function(a) { for (var b = [], c = 0, d = a.length; c < d; ++c) { var e = a[c].replace(/\./g, "_").replace(/-/g, "_");
                Ua.test(e) && b.push(e) } return b.join(",") },
        bb = function(a, b, c) { a = a[b];!a && c && N("missing: " + b); if (a) { if (Sa.test(a)) return a;
                N("invalid: " + b) } return null },
        Xa = /^https?:\/\/[a-z0-9_.-]+\.google\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,
        Wa = /\/cb=/g,
        Va = /\/\//g,
        cb = function() { var a = J(q.href); if (!a) throw Error("Bad hint"); return a };
    Pa.m = function(a, b, c, d) {
        (a = a[0]) || N("missing_hint"); return "https://apis.google.com" + ab(a, b, c, d) };
    var O = decodeURI("%73cript"),
        db = /^[-+_0-9\/A-Za-z]+={0,2}$/,
        eb = function(a, b) { for (var c = [], d = 0; d < a.length; ++d) { var e = a[d];
                e && 0 > fa.call(b, e) && c.push(e) } return c },
        fb = function() {
            var a = I.nonce;
        ...
        hb = function(a) { if ("loading" != p.readyState) gb(a);
            else { var b = fb(),
                    c = "";
                null !== b && (c = ' nonce="' + b + '"');
                p.write("<" + O + ' src="' + encodeURI(a) + '"' + c + "></" + O + ">") } },
        gb = function(a) { var b = p.createElement(O);
        ...
        ib = function(a, b) {
            ...
            if (c)
                for (var d =
                        0; d < M.length; d++) { var e = M[d][0],
                        f = M[d][1];
                    f && x(c, e) && f(c[e], a, b) }
        },
        kb = function(a, b, c) { jb(function() { var c;
        ...
        P = function(a, b) {
            ...
            if (e["::"] && b.length) {
                ...
                for (var f = null; f = b.shift();) { var g = f.split("."),
                        ...
                        h = k;
                    k && k.hint == g || (h = { hint: g, M: [] }, a.push(h));
                    h.M.push(f) }
                var l =
                    a.length;
                if (1 < l) { var m = c.callback;
                    m && (c.callback = function() { 0 == --l && m() }) }
        ...
        lb = function(a, b, c) {
            ...
            var k = u(Ja(c), "r", []).sort(),
                ...
                t = function(a, b) {
                    ...
                    if (b) { Oa("me0", a, w); try { kb(b, c, h) } finally { Oa("me1", a, w) } }
                    return 1
                };
            0 < f && (l = n.setTimeout(function() { m = !0;
                g() }, f));
            var y = eb(a, r);
            if (y.length) {
                var y = eb(a, k),
                    F = u(I, "CP", []),
                    G = F.length;
                F[G] = function(a) { if (!a) return 0;
                    Oa("ml1", y, w); var b = function(b) { F[G] = null;
                            t(y, a) && Ia(function() { d && d();
                                b() }) },
                        c = function() { var a = F[G + 1];
                            a && a() };
                    0 < G && F[G - 1] ? F[G] = function() { b(c) } : b(c) };
                if (y.length) {
                    var qa = "loaded_" + I.I++;
                    C[qa] = function(a) { F[G](a);
                        C[qa] = null };
                    a = Ya(c, y, "gapi." + qa, k);
                    k.push.apply(k, y);
                    Oa("ml0", y, w);
    ...
    var jb = function(a, b) { if (I.hee && 0 < I.hel) try { return a() } catch (c) { b && b(c), I.hel--, P("debug_error", function() { try { window.___jsl.hefn(c) } catch (d) { throw c; } }) } else try { return a() } catch (c) { throw b && b(c), c; } };
    C.load = function(a, b) { return jb(function() { return P(a, b) }) };
    var Q = function(a) { var b = window.___jsl = window.___jsl || {};
            b[a] = b[a] || []; return b[a] },
        R = function(a) { var b = window.___jsl = window.___jsl || {};
            b.cfg = !a && b.cfg || {}; return b.cfg },
        mb = function(a) { return "object" === typeof a && /\[native code\]/.test(a.push) },
        S = function(a, b) { if (b)
        ...
        nb = function(a) {
            if (a && !/^\s+$/.test(a)) {
                ...
                var b;
                try { b = window.JSON.parse(a) } catch (c) {}
        ...
        T = function(a) { if (!a) return R();
            a = a.split("/"); for (var b = R(), c = 0, d = a.length; b && "object" === typeof b && c < d; ++c) b = b[a[c]]; return c === a.length && void 0 !== b ? b : void 0 },
        pb = function(a, b) { var c = a; if ("string" === typeof a) { var d = c = {};
                a = a.split("/"); for (var e = 0, f = a.length; e < f - 1; ++e) var g = {},
                    d = d[a[e]] = g;
                d[a[e]] = b }
            ob(c) };
    var qb = function() { var a = window.__GOOGLEAPIS;
        a && (a.googleapis && !a["googleapis.config"] && (a["googleapis.config"] = a.googleapis), u(I, "ci", []).push(a), window.__GOOGLEAPIS = void 0) };
    var rb = { apppackagename: 1, callback: 1, clientid: 1, cookiepolicy: 1, openidrealm: -1, includegrantedscopes: -1, requestvisibleactions: 1, scope: 1 },
        sb = !1,
        tb = v(),
        ub = function() { if (!sb) { for (var a = document.getElementsByTagName("meta"), b = 0; b < a.length; ++b) { var c = a[b].name.toLowerCase(); if (0 == c.lastIndexOf("google-signin-", 0)) { var c = c.substring(14),
                            d = a[b].content;
                        rb[c] && d && (tb[c] = d) } } if (window.self !== window.top) { var a = document.location.toString(),
                        e; for (e in rb) 0 < rb[e] && (b = D(a, e, "")) && (tb[e] = b) }
                sb = !0 }
            e = v();
            A(tb, e); return e },
        vb = function(a) { return !!(a.clientid && a.scope && a.callback) };
    var wb = window.console,
        xb = function(a) { wb && wb.log && wb.log(a) };
    var yb = function() { return !!I.oa },
        zb = function() {};
    var U = u(I, "rw", v()),
        Ab = function(a) { for (var b in U) a(U[b]) },
        Bb = function(a, b) {
    ...
    var Db = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/u\/(\d)\//,
        ...
        Gb = function(a) { var b = T("googleapis.config/sessionDelegate"); "string" === typeof b && 21 < b.length && (b = null);
            null == b && (b = (a = (a || window.location.href).match(Eb)) ? a[1] : null); if (null == b) return null;
            b = String(b);
            21 < b.length && (b = null); return b };
    var Hb = function() { this.i = -1 };
    var V = function() { this.i = 64;
        this.b = [];
        this.C = [];
        this.V = [];
        this.w = [];
        this.w[0] = 128; for (var a = 1; a < this.i; ++a) this.w[a] = 0;
        this.A = this.l = 0;
        this.reset() };
    (function() {
        function a() {}
        ...
        V.fa = Hb.prototype;
        V.prototype = new a;
        V.v = function(a, c, d) { for (var b = Array(arguments.length - 2), f = 2; f < arguments.length; f++) b[f - 2] = arguments[f]; return Hb.prototype[c].apply(a, b) } })();
    ...
    V.prototype.update = function(a, b) { if (null != a) { void 0 === b && (b = a.length); for (var c = b - this.i, d = 0, e = this.C, f = this.l; d < b;) { if (0 == f)
                    for (; d <= c;) Ib(this, a, d), d += this.i; if ("string" == typeof a)
                    for (; d < b;) { if (e[f] = a.charCodeAt(d), ++f, ++d, f == this.i) { Ib(this, e);
                            f = 0; break } } else
                        for (; d < b;)
                            if (e[f] = a[d], ++f, ++d, f == this.i) { Ib(this, e);
                                f = 0; break } }
            this.l = f;
            this.A += b } };
    V.prototype.digest = function() { var a = [],
            b = 8 * this.A;
        56 > this.l ? this.update(this.w, 56 - this.l) : this.update(this.w, this.i - (this.l - 56)); for (var c = this.i - 1; 56 <= c; c--) this.C[c] = b & 255, b /= 256;
        Ib(this, this.C); for (c = b = 0; 5 > c; c++)
            for (var d = 24; 0 <= d; d -= 8) a[b] = this.b[c] >> d & 255, ++b; return a };
    var Jb = function() { this.G = new V };
    Jb.prototype.reset = function() { this.G.reset() };
    var Kb = n.crypto,
        Lb = !1,
        Mb = 0,
        Nb = 0,
    ...
    var Tb = function() { var a = Ob,
                a = a + parseInt(Qb.substr(0, 20), 16);
            Qb = Sb(Qb); return a / (Pb + Math.pow(16, 20)) },
        Ub = function() { var a = new n.Uint32Array(1);
            Kb.getRandomValues(a); return Number("0." + a[0]) };
    var Vb = function() { var a = I.onl; if (!a) { a = v();
                I.onl = a; var b = v();
                a.e = function(a) { var c = b[a];
                    c && (delete b[a], c()) };
                a.a = function(a, d) { b[a] = d };
                a.r = function(a) { delete b[a] } } return a },
        Wb = function(a, b) { b = b.onload; return "function" === typeof b ? (Vb().a(a, b), b) : null },
        Xb = function(a) { B(/^\w+$/.test(a), "Unsupported id - " + a);
            Vb(); return 'onload="window.___jsl.onl.e(&#34;' + a + '&#34;)"' },
        Yb = function(a) { Vb().r(a) };
    var Zb = { allowtransparency: "true", frameborder: "0", hspace: "0", marginheight: "0", marginwidth: "0", scrolling: "no", style: "", tabindex: "0", vspace: "0", width: "100%" },
        ...
        cc = function(a, b, c, d, e) {
            ...
            var f, g = Wb(d, c),
                k = g ? Xb(d) : "";
            try { document.all && (f = a.createElement('<iframe frameborder="' + ma(String(c.frameborder)) + '" scrolling="' + ma(String(c.scrolling)) + '" ' + k + ' name="' + ma(String(c.name)) + '"/>')) } catch (l) {} finally {
                f ||
    ...
    var dc = /^:[\w]+$/,
        ec = /:([a-zA-Z_]+):/g,
        fc = function() { var a = Fb() || "0",
                b = Gb(),
                c;
            c = Fb(void 0) || a; var d = Gb(void 0),
                e = "";
            c && (e += "u/" + encodeURIComponent(String(c)) + "/");
            d && (e += "b/" + encodeURIComponent(String(d)) + "/");
            c = e || null;
            (e = (d = !1 === T("isLoggedIn")) ? "_/im/" : "") && (c = ""); var f = T("iframes/:socialhost:"),
    ...
    var ic = { "\b": "\\b", "\t": "\\t", "\n": "\\n", "\f": "\\f", "\r": "\\r", '"': '\\"', "\\": "\\\\" },
        jc = function(a) {
            ...
            if (void 0 !== a) {
                switch (typeof a) {
                    case "string":
                        return b.test(a) ? '"' + a.replace(b, function(a) { var b = ic[a]; if (b) return b;
                            b = a.charCodeAt(); return "\\u00" + Math.floor(b / 16).toString(16) + (b % 16).toString(16) }) + '"' : '"' + a + '"';
                    case "number":
                    ...
                    case "object":
                        ...
                        b = [];
                        if ("number" ===
                            typeof a.length && !a.propertyIsEnumerable("length")) { d = a.length; for (c = 0; c < d; c += 1) b.push(jc(a[c]) || "null"); return "[" + b.join(",") + "]" }
        ...
        kc = function(a) { if (!a) return !1; if (/^[\],:{}\s]*$/.test(a.replace(/\\["\\\/b-u]/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, "]").replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) try { return eval("(" + a + ")") } catch (b) {}
            return !1 },
        lc = !1;
    try { lc = !!window.JSON && '["a"]' === window.JSON.stringify(["a"]) && "a" === window.JSON.parse('["a"]')[0] } catch (a) {}
    var mc = function(a) { try { return window.JSON.parse(a) } catch (b) { return !1 } },
        nc = lc ? window.JSON.stringify : jc,
        oc = lc ? mc : kc;
    var pc = function(a) { var b;
            a.match(/^https?%3A/i) && (b = decodeURIComponent(a)); return ya(document, b ? b : a) },
        qc = function(a) { a = a || "canonical"; for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) { var e = b[c],
                    f = e.getAttribute("rel"); if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = pc(e)) && null != e.match(/^https?:\/\/[\w\-\_\.]+/i)) return e } return window.location.href };
    var rc = { se: "0" },
        sc = { post: !0 },
        ...
        wc = function(a, b, c) {
            ...
            f.exp = T(g + "exp");
            if (g = T(g + "location"))
                for (e = 0; e < g.length; e++) { var k = g[e];
                    f[k] = n.location[k] }
            switch (a) {
                case "plus":
                case "follow":
        ...
        yc = function(a) { var b = void 0; "number" === typeof a ? b = a : "string" === typeof a && (b = parseInt(a, 10)); return b },
        Bc = function() {
            var a = I.drw;
            Ab(function(b) {
    ...
    var W, X, Y, Cc, Dc, Ec = /(?:^|\s)g-((\S)*)(?:$|\s)/,
        Fc = { plusone: !0, autocomplete: !0, profile: !0, signin: !0, signin2: !0 };
    W = u(I, "SW", v());
    X = u(I, "SA", v());
    Y = u(I, "SM", v());
    Cc = u(I, "FW", []);
    ...
    var Hc = function(a, b) { Gc(void 0, !1, a, b) },
        Gc = function(a, b, c, d) {
            ...
            var e;
            e = p.documentMode;
            if (c.querySelectorAll && (!e || 8 < e)) { e = d ? [d] : z(W).concat(z(X)).concat(z(Y)); for (var f = [], g = 0; g < e.length; g++) { var k = e[g];
                    f.push(".g-" + k, "g\\:" + k) }
            ...
            L("ps1", !0);
            if ((r = Cc.join(":")) || a) try { C.load(r, a) } catch (y) { xb(y); return }
            if (Ic(Dc || {}))
                for (var t in c) {
                    a = c[t];
                    w = 0;
        ...
        Mc = function(a) { var b = u(C, a, {});
            b.go || (b.go = function(b) { return Hc(b, a) }, b.render = function(b, d) { d = d || {};
                d.type = a; return Ac(b, d) }) },
        Nc = function(a) { W[a] = !0 },
        Oc = function(a) { X[a] = !0 },
        Pc = function(a) { Y[a] = !0 };
    var Jc = function(a, b) { var c = Ha(a);
            b && c ? (c(b), (c = b.iframeNode) && c.setAttribute("data-gapiattached", !0)) : C.load(a, function() { var c = Ha(a),
                    e = b && b.iframeNode,
                    f = b && b.userParams;
        ...
        Qc = function(a, b, c) { if (a && 1 === a.nodeType && b) { if (c) return 1; if (Y[b]) { if (Fa[a.nodeName.toLowerCase()]) return (a = a.innerHTML) && a.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "") ? 0 : 1 } else { if (X[b]) return 0; if (W[b]) return 1 } } return null },
        Ac = function(a, b) {
            var c = b.type;
            delete b.type;
    ...
    u(C, "platform", {}).go = Hc;
    var Ic = function(a) { for (var b = ["_c", "jsl", "h"], c = 0; c < b.length && a; c++) a = a[b[c]];
            b = J(q.href); return !a || 0 != a.indexOf("n;") && 0 != b.indexOf("n;") && a !== b },
        Lc = function(a, b) { Rc(a, b) },
        Ba = function(a) { Gc(a, !0) },
        Sc = function(a, b) { b = b || []; for (var c = 0; c < b.length; ++c) a(b[c]); for (a = 0; a < b.length; a++) Mc(b[a]) };
    M.push(["platform", function(a, b, c) { Dc = c;
        b && Cc.push(b);
        Sc(Nc, a);
        Sc(Oc, c._c.annotation);
        Sc(Pc, c._c.bimodal);
        qb();
        ob(); if ("explicit" != T("parsetags")) { Ga(a);
            vb(ub()) && !T("disableRealtimeCallback") && zb(); var d;
            c && (a = c.callback) && (d = na(a), delete c.callback);
            Da(function() { Ba(d) }) } }]);
    C._pl = !0;
    var Tc = function(a) { a = (a = U[a]) ? a.oid : void 0; if (a) { var b = p.getElementById(a);
    ...
    var Uc = /^\{h\:'/,
        ...
        Wc = "",
        Rc = function(a, b) {
            function c() { H("message", d, "remove", "de") }

            function d(d) { var f = d.data,
                    k = d.origin; if (Xc(f, b)) { var h = e;
                    e = !1;
                    h && L("rqe");
                    Yc(a, function() { h && L("rqd");
                        c(); for (var a = u(I, "RPMQ", []), b = 0; b < a.length; b++) a[b]({ data: f, origin: k }) }) } } if (0 !== b.length) { Wc = D(q.href, "pfname", ""); var e = !0;
                H("message", d, "add", "at");
                P(a, c) } },
        Xc = function(a, b) {
            a = String(a);
            ...
            if (d.s && a && -1 != fa.call(b, a)) {
                if ("_renderstart" === d.s || d.s === Wc + "/" + a + "::_renderstart")
                    if (d = d.a && d.a[c ? 0 : 1], b = p.getElementById(a), Bb(a, 2), d && b && d.width && d.height) {
                        a: {
                            c = b.parentNode;a = d || {};
                            if (yb()) { var e = b.id; if (e) { d = (d = U[e]) ? d.state : void 0; if (1 === d || 4 === d) break a;
                                    Tc(e) } }(d = c.nextSibling) && d.getAttribute && d.getAttribute("data-gapistub") && (c.parentNode.removeChild(d), c.style.cssText = "");
                            var d = a.width,
                                f = a.height,
        ...
        Yc = function(a, b) { P(a, b) };
    var Zc = function(a, b) { this.O = a;
            a = b || {};
    ...
    Zc.prototype.write = function(a, b) { if (!ad.test(this.O)) throw "Invalid cookie name"; if (!$c.test(a)) throw "Invalid cookie value";
        a = this.O + "=" + a;
    ...
    Zc.iterate = function(a) { for (var b = document.cookie.split(/;\s*/), c = 0; c < b.length; ++c) { var d = b[c].split("="),
                e = d.shift();
            a(e, d.join("=")) } };
    var bd = function(a) { this.X = a },
        cd = {};
    bd.prototype.write = function(a) { cd[this.X] = a; return !0 };
    bd.iterate = function(a) { for (var b in cd) cd.hasOwnProperty(b) && a(b, cd[b]) };
    var dd = "https:" === window.location.protocol,
        ed = dd || "http:" === window.location.protocol ? Zc : bd,
        fd = function(a) { var b = a.substr(1),
                c = "",
                d = window.location.hostname; if ("" !== b) { c = parseInt(b, 10); if (isNaN(c)) return null;
                b = d.split("."); if (b.length < c - 1) return null;
                b.length == c - 1 && (d = "." + d) } else d = ""; return { g: "S" == a.charAt(0), domain: d, j: c } },
        gd = function() { var a, b = null;
            ed.iterate(function(c, d) { 0 === c.indexOf("G_AUTHUSER_") && (c = fd(c.substring(11)), !a || c.g && !a.g || c.g == a.g && c.j > a.j) && (a = c, b = d) }); return { W: a, B: b } };
    var hd = function(a) { if (0 !== a.indexOf("GCSC")) return null; var b = { N: !1 };
            a = a.substr(4); if (!a) return b; var c = a.charAt(0);
            a = a.substr(1); var d = a.lastIndexOf("_"); if (-1 == d) return b; var e = fd(a.substr(d + 1)); if (null == e) return b;
            a = a.substring(0, d); if ("_" !== a.charAt(0)) return b;
            d = "E" === c && e.g; return !d && ("U" !== c || e.g) || d && !dd ? b : { N: !0, g: d, ca: a.substr(1), domain: e.domain, j: e.j } },
        id = function(a) { if (!a) return [];
        ...
        kd = function() { var a = gd(),
                b = a.W,
                a = a.B; if (null !== a) { var c;
                ed.iterate(function(a, d) {
                    (a = hd(a)) && a.N && a.g == b.g && a.j == b.j && (c = d) }); if (c) { var d = jd(c),
                        e = d && d.ba[Number(a)],
                        d = d && d.D; if (e) return { B: a, aa: e, D: d } } } return null };
    var Z = function(a) { this.K = a };
    Z.prototype.o = 0;
    Z.prototype.H = 2;
    Z.prototype.K = null;
    Z.prototype.F = !1;
    Z.prototype.T = function() { this.F || (this.o = 0, this.F = !0, this.R()) };
    Z.prototype.R = function() { this.F && (this.K() ? this.o = this.H : this.o = Math.min(2 * (this.o || this.H), 120), window.setTimeout(ca(this.R, this), 1E3 * this.o)) };
    for (var ld = 0; 64 > ld; ++ld);
    var md = null,
        yb = function() { return I.oa = !0 },
        zb = function() { I.oa = !0; var a = kd();
